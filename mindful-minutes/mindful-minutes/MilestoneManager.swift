...
class MilestoneManager {
    ...
    func updateProgress(_ progress: ProgressUpdate) {
        for milestone in milestones {
            ...
            case .streak:
                milestone.currentValue = max(progress.longestStreak, progress.currentStreak)
            case .weeklyGoal:
                milestone.currentValue = progress.weeklyMinutes
            case .monthlyGoal:
                milestone.currentValue = progress.monthlyMinutes
            }
